                                ...
                                <table className="table table-striped mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/1.png" alt loading="lazy" />
                                            ...
                                            <td className="text-dark">548</td>
                                            <td>
                                                <span className="badge bg-soft-primary p-2 text-primary">Active</span>
                                            </td>
                                            <td>
                                                <div className="d-flex justify-content-evenly">
                                                    <a className="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button">
                                                    ...
                                                    <a className="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="#" role="button">
                                                        <span className="btn-inner">
                                                            <svg className="icon-32" width={32} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/2.png" alt loading="lazy" />
                                                    <div className="media-support-info">
                                            ...
                                            <td className="text-dark">256</td>
                                            <td>
                                                <span className="badge bg-soft-warning p-2 text-warning">Pending</span>
                                            </td>
                                            <td>
                                                <div className="d-flex justify-content-evenly">
                                                    <a className="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/3.png" alt loading="lazy" />
                                                    <div className="media-support-info">
                                            ...
                                            <td className="text-dark">481</td>
                                            <td>
                                                <span className="badge bg-primary p-2 text-white">Hold</span>
                                            </td>
                                            <td>
                                                <div className="d-flex justify-content-evenly">
                                                    <a className="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/4.png" alt loading="lazy" />
                                                    <div className="media-support-info">
                                            ...
                                            <td className="text-dark">324</td>
                                            <td>
                                                <span className="badge bg-soft-success p-2 text-success">Complete</span>
                                            </td>
                                            <td>
                                                <div className="d-flex justify-content-evenly">
                                                    <a className="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/5.png" alt loading="lazy" />
                                                    <div className="media-support-info">
                                            ...
                                            <td className="text-dark">123</td>
                                            <td>
                                                <span className="badge bg-soft-danger p-2 text-danger">Inactive</span>
                                            </td>
                                            <td>
                                                <div className="d-flex justify-content-evenly">
                                                    <a className="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/6.png" alt loading="lazy" />
                                                    <div className="media-support-info">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/7.png" alt loading="lazy" />
                                                    <div className="media-support-info">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/8.png" alt loading="lazy" />
                                                    <div className="media-support-info">
                                                        <h5 className="iq-sub-label">Elon Musk</h5>
                                                        <p className="mb-0">@musk</p>
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img className="rounded img-fluid avatar-65 me-3" src="/admin/images/table/9.png" alt loading="lazy" />
                                                    <div className="media-support-info">
                                                        <h5 className="iq-sub-label">Elon Musk</h5>
                                                        <p className="mb-0">@musk</p>
                                                    </div>
