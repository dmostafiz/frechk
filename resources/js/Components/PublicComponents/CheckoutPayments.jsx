...
export default function CheckoutPayments() {
    ...
    function submitOrder(e, paymentMethod) {
        ...
        Inertia.post(route('submit_order', { paymentMethod: paymentMethod }))
    }

    return (
        <div className="bg-white rounded shadow-sm p-4 osahan-payment">
            <h4 className="mb-1">Choose payment method</h4>
            <h6 className="mb-3 text-black-50">Cash on delivery</h6>
            <div className="row">
                <div className="col-sm-4 pr-0">
                    <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a className="nav-link active" id="v-pills-cash-tab" data-toggle="pill" href="#v-pills-cash" role="tab" aria-controls="v-pills-cash" aria-selected="false"><i className="icofont-money" /> Pay on Delivery</a>
                    </div>
                </div>
