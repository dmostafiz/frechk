    ...
    return (
        <aside className="sidebar sidebar-default navs-rounded-all ">
            <div className="sidebar-header d-flex align-items-center justify-content-start">
                <Link href={route("admin.dashboard")} className="navbar-brand">
                    {/*Logo start*/}
                    {/* <Logo width={150}/> */}
                    {/*logo End*/}
                ...
                <div className="sidebar-list">
                    ...
                    <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${activeLink('admin.dashboard', 'active')}`} aria-current="page" href={route("admin.dashboard")}>
                                <i className="icon">
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${activeLink('admin.menu.*', 'active')}`} href={route("admin.menu.all")} role="button" aria-expanded="false" aria-controls="menus">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="item-name">Menu Items</span>
                            ...
                            <ul className={`sub-nav ${!activeLink('admin.menu.*') && 'collapse'}`} id="menus" data-bs-parent="#sidebar-menu">

                                <li className="nav-item">
                                    <Link className={`nav-link ${route().current('admin.menu.all') && 'active'}`} href={route("admin.menu.all")}>
                                        <i className="icon">
                                        ...
                                        <span className="item-name"> Menu list </span>
                                    </Link>
                                </li>

                                <li className="nav-item">
                                    <Link className={`nav-link ${route().current('admin.menu.create') && 'active'}`} href={route('admin.menu.create')}>
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                        ...
                                        <i className="sidenav-mini-icon"> H </i>
                                        <span className="item-name"> Create Menu </span>
                                    </Link>
                                </li>
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${activeLink('admin.category.*', 'active')}`} href={route("admin.category.categories")} role="button" aria-expanded="false" aria-controls="categories">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul className={`sub-nav ${!activeLink('admin.category.*') && 'collapse'}`} id="categories" data-bs-parent="#sidebar-menu">

                                <li className="nav-item">
                                    <Link className={`nav-link ${route().current('admin.category.categories') && 'active'}`} href={route("admin.category.categories")}>
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                        ...
                                        <i className="sidenav-mini-icon"> H </i>
                                        <span className="item-name">Menu categories </span>
                                    </Link>
                                </li>

                                <li className="nav-item">
                                    <Link className={`nav-link ${route().current('admin.category.tags') && 'active'}`} href={route('admin.category.tags')}>
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                        ...
                                        <i className="sidenav-mini-icon"> H </i>
                                        <span className="item-name">Menu tags</span>
                                    </Link>
                                </li>
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-special" role="button" aria-expanded="false" aria-controls="sidebar-special">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul className="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/special-pages/billing.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/special-pages/calender.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/special-pages/kanban.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/special-pages/pricing.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/special-pages/rtl-support.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/special-pages/timeline.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false" aria-controls="sidebar-user">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul className="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                                <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-user" role="button" aria-expanded="false" aria-controls="sidebar-user">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#utilities-error" role="button" aria-expanded="false" aria-controls="utilities-error">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul className="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/errors/error500.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/errors/maintenance.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="https://templates.iqonic.design/hope-ui/html/dist/#accordion">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-widget" role="button" aria-expanded="false" aria-controls="sidebar-widget">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul className="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/widget/widgetbasic.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/widget/widgetchart.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/widget/widgetcard.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-maps" role="button" aria-expanded="false" aria-controls="sidebar-maps">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul className="sub-nav collapse" id="sidebar-maps" data-bs-parent="#sidebar-menu">
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/maps/vector.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-form" role="button" aria-expanded="false" aria-controls="sidebar-form">
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul className="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar-menu">
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/form/form-element.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/form/form-wizard.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/form/form-validation.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-table" role="button" aria-expanded="false" aria-controls="sidebar-table">
                                <i className="icon">
                            ...
                            <ul className="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/table/bootstrap-table.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/table/table-data.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                        ...
                        <li className="nav-item mb-5">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-icons" role="button" aria-expanded="false" aria-controls="sidebar-icons">
                                <i className="icon">
                            ...
                            <ul className="sub-nav collapse" id="sidebar-icons" data-bs-parent="#sidebar-menu">
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/icons/solid.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
                                ...
                                <li className="nav-item">
                                    <a className="nav-link " href="../dashboard/icons/dual-tone.html">
                                        <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx={12} cy={12} r={8} fill="currentColor" />
