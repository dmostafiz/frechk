            ...
            <div className="sidebar-body pt-0 data-scrollbar">
                <div className="sidebar-list">
                    ...
                    <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${activeLink('admin.deliveries', 'active')}`} href={route('admin.deliveries')}>
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="item-name">Today Deliveries</span>
                            </Link>
                        </li>

                        <li className="nav-item static-item">
                            <a className="nav-link static-item disabled" href="#" tabIndex={-1}>
                                <span className="default-icon">Frechk Store</span>
                                <span className="mini-icon">-</span>
                            </a>
                        </li>
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${activeLink('admin.package.*', 'active')}`} href={route('admin.package.all')}>
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="nav-item static-item">
                            <a className="nav-link static-item disabled" href="#" tabIndex={-1}>
                                <span className="default-icon">Sales</span>
                                <span className="mini-icon">-</span>
                            </a>
                        </li>
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${activeLink('admin.subscription.*', 'active')}`} href={route('admin.subscription.all')}>
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M2 11.0786C2.05 13.4166 2.19 17.4156 2.21 17.8566C2.281 18.7996 2.642 19.7526 3.204 20.4246C3.986 21.3676 4.949 21.7886 6.292 21.7886C8.148 21.7986 10.194 21.7986 12.181 21.7986C14.176 21.7986 16.112 21.7986 17.747 21.7886C19.071 21.7886 20.064 21.3566 20.836 20.4246C21.398 19.7526 21.759 18.7896 21.81 17.8566C21.83 17.4856 21.93 13.1446 21.99 11.0786H2Z" fill="currentColor" />
                                        <path d="M11.2451 15.3843V16.6783C11.2451 17.0923 11.5811 17.4283 11.9951 17.4283C12.4091 17.4283 12.7451 17.0923 12.7451 16.6783V15.3843C12.7451 14.9703 12.4091 14.6343 11.9951 14.6343C11.5811 14.6343 11.2451 14.9703 11.2451 15.3843Z" fill="currentColor" />
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${activeLink('admin.orders.*', 'active')}`} href={route('admin.orders.all')}>
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="item-name">Direct Orders</span>
                                <i>
                                   <span className="badge rounded-pill bg-success">{newOrders.length}</span>
                                </i>
                            </Link>
                        </li>
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${activeLink('admin.customers.*', 'active')}`} href={route('admin.customers.all')}>
                                <i className="icon">
                                    <svg width={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="nav-item static-item">
                            <a className="nav-link static-item disabled" href="#" tabIndex={-1}>
                                <span className="default-icon">System</span>
                                <span className="mini-icon">-</span>
                            </a>
                        </li>
                        ...
                        <li className="nav-item">
                            <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-widget" role="button" aria-expanded="false" aria-controls="sidebar-widget">
                                ...
                                <span className="item-name">General Settings</span>
                            </a>
                        </li>
